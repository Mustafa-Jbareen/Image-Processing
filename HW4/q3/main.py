...
if __name__ == "__main__":
    ...
    # cv2.imwrite(r"C:\CS Courses\Image Processing\Hw\HW4\q3\Images\baby_clean.tif", im1_clean.astype("uint8"))
    ...
    # cv2.imwrite(r"C:\CS Courses\Image Processing\Hw\HW4\q3\Images\windmill_clean.tif", im2_clean.astype("uint8"))
    ...
    # cv2.imwrite(r"C:\CS Courses\Image Processing\Hw\HW4\q3\Images\watermelon_clean.tif", im3_clean.astype("uint8"))
    ...
    # cv2.imwrite(r"C:\CS Courses\Image Processing\Hw\HW4\q3\Images\umbrella_clean.tif", im4_clean.astype("uint8"))
    ...
    # cv2.imwrite(r"C:\CS Courses\Image Processing\Hw\HW4\q3\Images\USAflag_clean.tif", im5_clean.astype("uint8"))
    ...
    cv2.imwrite(r"C:\CS Courses\Image Processing\Hw\HW4\q3\Images\house_clean.tif", im6_clean.astype(np.uint8))
    ...
    # cv2.imwrite(r"C:\CS Courses\Image Processing\Hw\HW4\q3\Images\bears_clean.tif", im7_clean.astype("uint8"))
